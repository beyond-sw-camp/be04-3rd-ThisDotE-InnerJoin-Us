    ...
    <div class="div-wrapper">
      <div class="div">
        ...
        <div class="group-11">
          ...
          <div class="text-wrapper-12">제목</div>
          <div class="text-wrapper-13">작성 날짜 및 시간</div>
          <div class="text-wrapper-14">작성자</div>
        </div>
        <div class="group-12">
          <img class="image-3" src="@/assets/img/MainPage/MainPageBeforeLogin/3.png" />
          <div class="group-13">
            <div class="text-wrapper-15">제목</div>
            <div class="text-wrapper-16">작성 날짜 및 시간</div>
            <div class="text-wrapper-17">작성자</div>
          </div>
          <div class="group-14">
